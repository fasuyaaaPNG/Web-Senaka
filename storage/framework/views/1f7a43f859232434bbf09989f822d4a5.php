       ...
       <div class="col-md-6 offset-md-3 mt-5">
           <div class="card">
               ...
               <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="POST" name="signature" action="<?php echo e(route('signaturepad.upload')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12">
...
<?php /**PATH C:\Users\fasuyaaa\Project\Web-Senaka\resources\views/signaturePad.blade.php ENDPATH**/ ?>